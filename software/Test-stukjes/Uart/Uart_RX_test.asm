;programma om een karakter te lezen met de HC-12 RF module met behulp van Roggemans zijn include file
    org 0000h
    mov sp,#7fh
    lcall  inituart1          	;klaar zetten van de sio en de poorten
    mov     p3_dir,#00001000b   ;pin 1.6 als output zetten voor de groene led
    
;------------hoofdprogramma------------
main:
    ;het karakter hoort 'aah' te zijn          
...
;***** Het probleem kan omzeild worden door mov scon1,# of door ANL scon1,#(allemaal 1 en een 0 op de plaats van bit x)
        ...
        clr p3_data.2              ;groene led aanzetten om ontvangst aan te tonen
